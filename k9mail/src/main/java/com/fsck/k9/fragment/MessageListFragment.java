...
public class MessageListFragment extends Fragment implements OnItemClickListener,
    ...
    public boolean onContextItemSelected(android.view.MenuItem item) {
        ...
        if (i == R.id.deselect || i == R.id.select) {
            ...
            // debug options
        } else if (i == R.id.debug_delete_locally) {
    ...
    class MessageViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            if (position != -1) {
                ...
                int i = view.getId();
                if (i == R.id.selected_checkbox) {
                    toggleMessageSelectWithAdapterPosition(position);

                } else if (i == R.id.flagged_bottom_right || i == R.id.flagged_center_right) {
