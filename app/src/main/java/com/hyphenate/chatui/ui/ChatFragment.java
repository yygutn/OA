...
import com.hyphenate.chatui.domain.RobotUser;
import com.hyphenate.chatui.widget.ChatRowVoiceCall;
...
//            RedPacketUtil.startRedPacketActivityForResult(this, chatType, toChatUsername, REQUEST_CODE_SEND_MONEY);
    ...
    final Integer SHORT = Toast.LENGTH_SHORT;
    ...
    protected void startVoiceCall() {
        if (!EMClient.getInstance().isConnected()) {
            Toast.makeText(getActivity(), R.string.not_connect_to_server, SHORT).show();
        } else {
