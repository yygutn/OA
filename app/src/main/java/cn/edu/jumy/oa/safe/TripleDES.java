...
public class TripleDES {
    ...
    /** Read a TripleDES secret key from the specified file */
    public static SecretKey readKey(String keyStr) throws IOException,
            NoSuchAlgorithmException, InvalidKeyException,
            InvalidKeySpecException {
        // Read the raw bytes from the keyStr
    ...
    public static byte[] simpleEncrypt(SecretKey key, byte[] in)
    ...
    public static byte[] simpleDecrypt(SecretKey key, byte[] in)
            throws NoSuchAlgorithmException, NoSuchPaddingException,
            InvalidKeyException, IllegalBlockSizeException, BadPaddingException {
        Cipher cipher = Cipher.getInstance("DESede");
