package cn.edu.jumy.oa.widget.datepicker.calendar.views;
...
import cn.edu.jumy.oa.widget.datepicker.calendar.bizs.calendars.DPCManager;
import cn.edu.jumy.oa.widget.datepicker.calendar.bizs.decors.DPDecor;
import cn.edu.jumy.oa.widget.datepicker.calendar.bizs.themes.DPTManager;
import cn.edu.jumy.oa.widget.datepicker.calendar.cons.DPMode;
import cn.edu.jumy.oa.widget.datepicker.calendar.entities.DPInfo;
...
//				return true;
    ...
    private void draw(Canvas canvas, Rect rect, DPInfo info) {
        ...
        drawGregorian(canvas, rect, info.strG, info.isWeekend, info.isToday, info.isDecorBG);
        drawFestival(canvas, rect, info.strF, info.isFestival, info.isDecorBG);
    ...
    private void drawGregorian(Canvas canvas, Rect rect, String str,
                               boolean isWeekend, boolean isToday, boolean isDecorBG) {
        mPaint.setTextSize(sizeTextGregorian);
        //自定义一个文本大小
//		mPaint.setTextSize(textSize);
    ...
    private void drawFestival(Canvas canvas, Rect rect, String str,
                              boolean isFestival, boolean isDecorBG) {
        if (!isFestivalDisplay) {
            return;
        }
        mPaint.setTextSize(sizeTextFestival);
