 ...
 */
public class OrgRelayAdapter extends IndexableAdapter<OrgRelay> {

    private Context mContext;
    public OrgRelayAdapter(Context context) {
    ...
    @Override
    protected void onBindViewHolder(ViewHolder holder, final OrgRelay item) {
        try {
    ...
    class DViewHolder extends ViewHolder{
        TextView tvName;
        CheckBox checkBox;
        RelativeLayout root;
