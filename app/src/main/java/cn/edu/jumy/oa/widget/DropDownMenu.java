...
/**
 * Created by Jumy on 16/6/23 12:09.
...
public class DropDownMenu extends LinearLayout {
     ...
     * @param contentView 1
     */
    public void setDropDownMenu(@NonNull List<String> tabTexts, @NonNull List<View> popupViews, @Nullable View contentView) {
    ...
    public void setTabTextColor(int res) {
        if (current_tab_position != -1) {
            ((TextView) tabMenuView.getChildAt(current_tab_position)).setTextColor(res);
        }
    }
